                                        ...
                                        <div className="pt-2">
                                            ...
                                            <ul className="list-inline mt-4">
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + github}
                                                        href="https://github.com/KabirSinghMehrok"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + behance}
                                                        href="https://www.behance.net/kabirsmehrok"
                                                        rel="noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
                                        ...
                                        <div className="pt-2">
                                            ...
                                            <ul className="list-inline mt-4">
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + github}
                                                        href="https://github.com/Khwaish-09"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + instagram}
                                                        href="https://instagram.com/khwaiiii_"
                                                        rel="noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
                                        ...
                                        <div className="pt-2">
                                            ...
                                            <ul className="list-inline mt-4">
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + github}
                                                        href="https://github.com/sc0rp10n-py"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
                                                ...
                                                <li className="list-inline-item">
                                                    <a
                                                        className={"text-decoration-none d-block px-1 " + instagram}
                                                        href="https://instagram.com/sc0rp10n.py"
                                                        rel="noreferrer"
                                                        target="_blank"
                                                    >
                                                        <svg
